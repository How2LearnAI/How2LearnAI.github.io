...
!!! note "Linear layers' parameters"
    ...
    If you're still unfamiliar with matrix product, go ahead and review the previous quick lesson where we covered it in [logistic regression](https://how2learnai.github.io/deep_learning/practical_pytorch/pytorch_logistic_regression/#step-6-instantiate-optimizer-class).
