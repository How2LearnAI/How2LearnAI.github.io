...
!!! tip "Options"
    ...
    === "**Hard/Scalable Option | Using Apptainer**"
        ...
        Follow our [tutorial on Apptainer](https://how2learnai.github.io/language_model/containers/hpc_containers_apptainer/) to get started. Once you have followed the tutorial till the [Ollama section](https://how2learnai.github.io/language_model/containers/hpc_containers_apptainer/#ollama-multi-modal-workloads-example-llava7b-v16) where you successfully ran `ollama serve` and `ollama run llava:13b`, you can run the `apptainer shell --nv --nvccli apptainer_container_0.1.sif` command followed by `jupyter lab` to access and run this notebook.
